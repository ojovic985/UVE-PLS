...
B2<-c(5.7, 5.5, 7.19, 5.15, 4.78, 5, 7.21, 5.92, 6.8, 4.5, 9.3, 7.19, 10.3, 8.3, 9, 5.33, 6.3, 6.51, 4, 5.55, 9.15, 6.63, 9.4, 6, 6.55, 5.35, 7.77, 8.05, 7.89, 4.3, 5.82, 7.18, 4, 5.93, 5.11, 8.7, 5.72, 10.05, 6.3, 9.82, 9.7, 6.77, 8.7, 6.41) # These are experimental pKi values (exactly following the labels)
